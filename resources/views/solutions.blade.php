                ...
                <div class="w-full flex flex-row justify-center items-center">
                    <div class="main-banner-content self-center md:text-center lg:text-left mb-30">
                        <h1 class="font-bold text-center text-25px md:text-40px lg:text-44px xl:text-55px 2xl:text-60px 3xl:text-70px text-black-color mb-10 md:mb-12 lg:mb-15">
                            <strong>Power Over <br>Your Make Ready Process</strong></h1>
                    </div>
                </div>
            </div>
        </div>
...
<div class="features-area flex flex-row justify-center items-center h-[100vh] pt-30 lg:pt-50 pb-60 md:pb-80 lg:pb-50 relative z-1 bg-cover bg-no-repeat"
        ...
        <div class="section-title md:mb-20 lg:mb-20 text-center flex flex-row items-center justify-between">
            <ul>
                <li class="mb-15 lg:mb-18 last:mb-0 relative flex flex-row items-center gap-18">
                    <img src="https://images.squarespace-cdn.com/content/v1/65e8d0f31425f9758c64fabb/b6518a23-a7aa-41b1-9593-ff11f5fb5042/Painting.png"
...
<div class="pt-60 pb-60 md:pt-80 lg:pt-100 bg-[#c0d1c0] relative z-1">
    <div class="container">
        <h1 class="font-bold text-center text-25px md:text-40px lg:text-44px xl:text-55px 2xl:text-60px 3xl:text-70px text-black-color mb-30 md:mb-30 lg:mb-50">
            Real Time Reporting & Dashboards</h1>
        <div class="grid md:gap-50 lg:gap-25 xl:gap-50 grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2">
            <div>
                <div class="relative flex flex-row items-start gap-20 ease-in duration-300 rounded-lg mt-25">
                    <div class="flex flex-row justify-start items-start pt-10 -z-1 mb-18 md:mb-0">
                        <img src="https://images.squarespace-cdn.com/content/v1/65e8d0f31425f9758c64fabb/a2795dca-6eca-4388-b7dc-0b55ec7e25b1/1.png">
                    </div>
                    <div>
            ...
            <div>
                <a href="blog-details.html" class="block">
                    <img src="https://images.squarespace-cdn.com/content/v1/65e8d0f31425f9758c64fabb/1f25fe2f-dbc8-4124-b880-04b1b1b90caf/Group+2772.png"
        ...
        <div class="container">
            <div class="flex flex-row justify-start items-center w-full relative">
                <div class="overview-image z-1 w-[50%] h-full">
                    <img src="https://images.squarespace-cdn.com/content/v1/65e8d0f31425f9758c64fabb/1b39e0e5-ca65-43ea-a36d-f910227c9019/1.png?format=750w 750w"
                         class="rounded-md wow animate__animated animate__fadeInUp" data-wow-delay=".1s" alt="">
                </div>
                <div class="overview-content w-[50%] flex flex-col justify-center items-center gap-18 self-center lg:relative lg:top-12 xl:top-20">
                    <img alt=""
...
<div class="pt-60 pb-60 md:pt-80 lg:pt-100 bg-[#c0d1c0] relative z-1">
    <div class="container">
        <div class="text-center xl:ml-auto xl:mr-auto xl:max-w-[1115px]">
            <h1 class="font-black text-black-color text-25px md:text-40px lg:text-51px xl:text-65px mb-12 md:mb-15 lg:mb-20">Ready to Level Up Your Make Ready Process? Let’s Talk.</h1>
            <a href="profile-authentication.html" class="inline-block mt-0 md:mt-5 lg:mt-10 font-semibold text-13px md:text-14px lg:text-15px rounded-xl text-white pt-17 pb-15 pl-35 pr-35 bg-[#14944c] shadow-custom-box-shadow hover:shadow-primary-btn ease-in duration-300">
