...
<div class="bg-[#c0d1c0]">
    <div class="main-banner-area relative z-1 h-screen">
        ...
        <div class="container absolute top-[15%] xl:max-w-full">
            <div class="flex flex-row justify-center">
                <div class="w-[45rem]">
                    <h2 class="font-bold text-22px md:text-30px lg:text-68px mb-25 lg:mb-35 text-black-color text-center">
                        Questions?</h2>
                    <form class="flex flex-col justify-center items-center" method="POST"
                        ...
                        <div class="w-full">
                            ...
                            <div class="p-20">
                                <label class="font-bold">Company (required)</label>
                            ...
                            <div class="p-20">
                                <label class="font-bold">Phone Number (required)</label>
                                <div class="grid gap-20 grid-cols-1 ">
                            ...
                            <div class="p-20">
                                <label class="font-bold">Email (required)</label>
                                <div class="grid gap-20 grid-cols-1 ">
                            ...
                            <div class="p-20">
                                <label class="font-bold">Questions? How can we help?</label>
                                <div class="grid gap-20 grid-cols-1 ">
                        ...
                        <button type="submit"
                                class="inline-block font-semibold text-13px md:text-14px lg:text-15px mt-15 md:mt-25 rounded-xl text-white pt-17 pb-13 pl-35 pr-35 bg-[#14944c] shadow-custom-box-shadow">
                            Submit
                        </button>
